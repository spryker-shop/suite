...
$config[SessionFileConstants::YVES_SESSION_FILE_PATH] = $config[SessionConstants::YVES_SESSION_FILE_PATH];
...
$config[SessionFileConstants::ZED_SESSION_FILE_PATH] = $config[SessionConstants::ZED_SESSION_FILE_PATH];
