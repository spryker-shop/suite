...
$yves = getenv('YVES_HOST', sprintf('http://www.de.%s.local', $domain));
$yves_url = parse_url($yves);
$config[ApplicationConstants::HOST_YVES] = $yves_url['host'];
$config[ApplicationConstants::PORT_YVES] = $yves_url['port'];
$config[ApplicationConstants::PORT_SSL_YVES] = '';
$config[ApplicationConstants::BASE_URL_YVES] = $yves;
...
// ---------- Zed host
$zed = getenv('ZED_HOST', sprintf('zed.de.%s.local', $domain));
$zed_url = parse_url($zed);
$config[ApplicationConstants::HOST_ZED] = $zed_url['host'];
$config[ApplicationConstants::PORT_ZED] = $zed_url['port'];
$config[ApplicationConstants::PORT_SSL_ZED] = '';
$config[ApplicationConstants::BASE_URL_ZED] = $zed;
...
// ----------- Glue Application
$glue = getenv('GLUE_HOST', sprintf('http://glue.de.%s.local', $domain));
