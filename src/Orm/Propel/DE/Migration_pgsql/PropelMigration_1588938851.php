 ...
 * up to version 1588938851.
 * Generated on 2020-05-08 11:54:11 by vagrant
 */
class PropelMigration_1588938851
{
    public $comment = '';
...
(
    ...
    CONSTRAINT "spy_acl_group-unique-reference" UNIQUE ("reference")
);
...
(
    ...
    CONSTRAINT "spy_merchant-unique-email" UNIQUE ("email"),
    CONSTRAINT "spy_merchant-unique-merchant_reference" UNIQUE ("merchant_reference"),
...
CREATE SEQUENCE "id_merchant_store_pk_seq";

CREATE TABLE "spy_merchant_store"
(
    "id_merchant_store" INTEGER NOT NULL,
    "fk_merchant" INTEGER NOT NULL,
    "fk_store" INTEGER NOT NULL,
    PRIMARY KEY ("id_merchant_store"),
    CONSTRAINT "spy_merchant_store-fk_merchant-fk_store" UNIQUE ("fk_merchant","fk_store")
);

CREATE SEQUENCE "spy_merchant_opening_hours_weekday_schedule_pk_seq";

CREATE TABLE "spy_merchant_opening_hours_weekday_schedule"
(
    "id_merchant_opening_hours_weekday_schedule" INTEGER NOT NULL,
    "fk_merchant" INTEGER NOT NULL,
    "fk_weekday_schedule" INTEGER NOT NULL,
    PRIMARY KEY ("id_merchant_opening_hours_weekday_schedule")
);

CREATE INDEX "spy_merchant_opening_hours_weekday_schedule-fk_weekday_schedule" ON "spy_merchant_opening_hours_weekday_schedule" ("fk_weekday_schedule");

CREATE INDEX "spy_merchant_opening_hours_weekday_schedule-fk_merchant" ON "spy_merchant_opening_hours_weekday_schedule" ("fk_merchant");

CREATE SEQUENCE "spy_merchant_opening_hours_date_schedule_pk_seq";

CREATE TABLE "spy_merchant_opening_hours_date_schedule"
(
    "id_merchant_opening_hours_date_schedule" INTEGER NOT NULL,
    "fk_date_schedule" INTEGER NOT NULL,
    "fk_merchant" INTEGER NOT NULL,
    PRIMARY KEY ("id_merchant_opening_hours_date_schedule")
);

CREATE INDEX "spy_merchant_opening_hours_date_schedule-fk_date_schedule" ON "spy_merchant_opening_hours_date_schedule" ("fk_date_schedule");

CREATE INDEX "spy_merchant_opening_hours_date_schedule-fk_merchant" ON "spy_merchant_opening_hours_date_schedule" ("fk_merchant");

CREATE SEQUENCE "id_merchant_opening_hours_storage_pk_seq";

CREATE TABLE "spy_merchant_opening_hours_storage"
(
    "id_merchant_opening_hours_storage" INTEGER NOT NULL,
    "fk_merchant" INTEGER NOT NULL,
    "data" TEXT,
    "key" VARCHAR NOT NULL,
    "created_at" TIMESTAMP,
...
CREATE INDEX "spy_merchant_opening_hours_storage-fk_merchant" ON "spy_merchant_opening_hours_storage" ("fk_merchant");

CREATE TABLE "spy_merchant_profile"
(
    "id_merchant_profile" serial NOT NULL,
    "fk_merchant" INTEGER NOT NULL,
    ...
    CONSTRAINT "spy_merchant_profile_unique_fk_merchant" UNIQUE ("fk_merchant")
);

CREATE SEQUENCE "spy_merchant_profile_address_pk_seq";

CREATE TABLE "spy_merchant_profile_address"
(
    "id_merchant_profile_address" INTEGER NOT NULL,
    "fk_country" INTEGER,
...
CREATE INDEX "index-spy_merchant_profile_address-fk_country" ON "spy_merchant_profile_address" ("fk_country");

CREATE INDEX "index-spy_merchant_profile_address-fk_merchant_profile" ON "spy_merchant_profile_address" ("fk_merchant_profile");
...
CREATE SEQUENCE "spy_merchant_sales_order_item_pk_seq";

CREATE TABLE "spy_merchant_sales_order_item"
(
    "id_merchant_sales_order_item" INTEGER NOT NULL,
    ...
    CONSTRAINT "spy_merchant_sales_order_item-unique-fk_sales_order_item" UNIQUE ("fk_sales_order_item")
);

CREATE INDEX "spy_merchant_sales_order_item-fk_merchant_sales_order" ON "spy_merchant_sales_order_item" ("fk_merchant_sales_order");

CREATE SEQUENCE "spy_merchant_sales_order_pk_seq";

CREATE TABLE "spy_merchant_sales_order"
(
    "id_merchant_sales_order" INTEGER NOT NULL,
    "fk_sales_order" INTEGER NOT NULL,
    "merchant_reference" VARCHAR(255) NOT NULL,
    ...
    CONSTRAINT "spy_merchant_sales_order-merchant_sales_order_reference" UNIQUE ("merchant_sales_order_reference")
);

CREATE INDEX "index-spy_merchant_sales_order-fk_sales_order" ON "spy_merchant_sales_order" ("fk_sales_order");

CREATE SEQUENCE "spy_merchant_sales_order_totals_pk_seq";

CREATE TABLE "spy_merchant_sales_order_totals"
(
    "id_merchant_sales_order_totals" INTEGER NOT NULL,
    "fk_merchant_sales_order" INTEGER NOT NULL,
...
CREATE INDEX "spy_sales_order_totals-fk_sales_order" ON "spy_merchant_sales_order_totals" ("fk_merchant_sales_order");

CREATE SEQUENCE "spy_merchant_stock_pk_seq";

CREATE TABLE "spy_merchant_stock"
(
    "id_merchant_stock" INTEGER NOT NULL,
    "is_default" BOOLEAN DEFAULT \'f\' NOT NULL,
    "fk_stock" INTEGER NOT NULL,
    "fk_merchant" INTEGER NOT NULL,
    PRIMARY KEY ("id_merchant_stock"),
    CONSTRAINT "spy_merchant_stock-fk_stock-fk_merchant" UNIQUE ("fk_merchant","fk_stock")
);

CREATE TABLE "spy_merchant_storage"
(
    "id_merchant_storage" serial NOT NULL,
    "id_merchant" INTEGER NOT NULL,
    "data" TEXT,
    ...
    CONSTRAINT "spy_merchant_storage-unique-key" UNIQUE ("key")
);

CREATE INDEX "spy_merchant_storage-id_merchant" ON "spy_merchant_storage" ("id_merchant");

CREATE SEQUENCE "spy_merchant_user_pk_seq";

CREATE TABLE "spy_merchant_user"
(
    "id_merchant_user" INTEGER NOT NULL,
    "fk_merchant" INTEGER NOT NULL,
    "fk_user" INTEGER NOT NULL,
    PRIMARY KEY ("id_merchant_user"),
    CONSTRAINT "fk_merchant_unique_fk_user_unique" UNIQUE ("fk_merchant","fk_user")
);

CREATE INDEX "index-spy_merchant_user-fk_user" ON "spy_merchant_user" ("fk_user");
...
CREATE SEQUENCE "spy_price_product_offer_pk_seq";

CREATE TABLE "spy_price_product_offer"
(
    "id_price_product_offer" INT8 NOT NULL,
    "fk_price_product_store" INT8 NOT NULL,
    "fk_product_offer" INTEGER NOT NULL,
    PRIMARY KEY ("id_price_product_offer"),
    CONSTRAINT "spy_price_product_offer-unique-fk_p_o-fk_p_p_s" UNIQUE ("fk_product_offer","fk_price_product_store")
);

CREATE INDEX "index-spy_price_product_offer-fk_price_product_store" ON "spy_price_product_offer" ("fk_price_product_store");
...
CREATE SEQUENCE "spy_product_concrete_product_offer_price_storage_pk_seq";

CREATE TABLE "spy_product_concrete_product_offer_price_storage"
(
    "id_product_concrete_product_offer_price_storage" INTEGER NOT NULL,
    "fk_product" INTEGER NOT NULL,
    "data" TEXT,
    "store" VARCHAR(128) NOT NULL,
    "key" VARCHAR,
    ...
    CONSTRAINT "spy_product_concrete_product_offer_price_storage-unique-key" UNIQUE ("key")
);

CREATE INDEX "spy_product_concrete_product_offer_price_storage-fk_product" ON "spy_product_concrete_product_offer_price_storage" ("fk_product");

CREATE SEQUENCE "spy_product_concrete_product_offers_storage_pk_seq";

CREATE TABLE "spy_product_concrete_product_offers_storage"
(
    "id_product_concrete_product_offers_storage" INTEGER NOT NULL,
    ...
    CONSTRAINT "spy_product_concrete_product_offers_storage-unique-key" UNIQUE ("key")
);

CREATE INDEX "spy_product_concrete_product_offer_storage-concrete_sku" ON "spy_product_concrete_product_offers_storage" ("concrete_sku");
...
CREATE INDEX "spy_product_image_i_8681df" ON "spy_product_image" ("product_image_key");
...
CREATE SEQUENCE "spy_product_offer_pk_seq";

CREATE TABLE "spy_product_offer"
(
    "id_product_offer" INTEGER NOT NULL,
    "fk_merchant" INTEGER NOT NULL,
    ...
    CONSTRAINT "spy_product_offer-product_offer_reference" UNIQUE ("product_offer_reference")
);

CREATE INDEX "spy_product_offer-merchant_sku" ON "spy_product_offer" ("merchant_sku");

CREATE INDEX "index-spy_product_offer-fk_merchant" ON "spy_product_offer" ("fk_merchant");
...
CREATE SEQUENCE "id_product_offer_availability_storage_pk_seq";

CREATE TABLE "spy_product_offer_availability_storage"
(
    "id_product_offer_availability_storage" INTEGER NOT NULL,
    "product_offer_reference" VARCHAR NOT NULL,
    "data" TEXT,
    "key" VARCHAR NOT NULL,
    "store" VARCHAR(255) NOT NULL,
    "created_at" TIMESTAMP,
...
CREATE INDEX "spy_product_offer_availability_storage-p-o-r" ON "spy_product_offer_availability_storage" ("product_offer_reference");

CREATE SEQUENCE "spy_product_offer_stock_pk_seq";

CREATE TABLE "spy_product_offer_stock"
(
    "id_product_offer_stock" INTEGER NOT NULL,
    "fk_product_offer" INTEGER NOT NULL,
    "fk_stock" INTEGER NOT NULL,
    "is_never_out_of_stock" BOOLEAN DEFAULT \'f\',
    "quantity" NUMERIC(20,10) DEFAULT 0,
    PRIMARY KEY ("id_product_offer_stock"),
    CONSTRAINT "spy_product_offer_stock-unique-fk_stock" UNIQUE ("fk_stock","fk_product_offer")
);

CREATE INDEX "index-spy_product_offer_stock-fk_product_offer" ON "spy_product_offer_stock" ("fk_product_offer");

CREATE SEQUENCE "spy_product_offer_storage_pk_seq";

CREATE TABLE "spy_product_offer_storage"
(
    "id_product_offer_storage" INTEGER NOT NULL,
    "product_offer_reference" VARCHAR(255) NOT NULL,
    "data" TEXT,
    "store" VARCHAR(128) NOT NULL,
    "key" VARCHAR,
    ...
    CONSTRAINT "spy_product_offer_storage-unique-key" UNIQUE ("key")
);

CREATE INDEX "spy_product_offer_storage-product_offer_reference" ON "spy_product_offer_storage" ("product_offer_reference");

CREATE SEQUENCE "spy_product_offer_validity_pk_seq";

CREATE TABLE "spy_product_offer_validity"
(
    "id_product_offer_validity" INTEGER NOT NULL,
    "fk_product_offer" INTEGER NOT NULL,
    "valid_from" TIMESTAMP,
    "valid_to" TIMESTAMP,
    PRIMARY KEY ("id_product_offer_validity"),
    CONSTRAINT "spy_product_offer_validity-fk_product_offer-unique" UNIQUE ("fk_product_offer")
);
...
CREATE INDEX "spy_sales_order_item-index-product_offer_reference" ON "spy_sales_order_item" ("product_offer_reference");
...
CREATE INDEX "index-spy_url-fk_resource_merchant" ON "spy_url" ("fk_resource_merchant");
...
CREATE SEQUENCE "spy_weekday_schedule_pk_seq";

CREATE TABLE "spy_weekday_schedule"
(
    "id_weekday_schedule" INTEGER NOT NULL,
    "day" INT2 NOT NULL,
    "time_from" TIME,
    "time_to" TIME,
    "created_at" TIMESTAMP,
...
(
    "id_date_schedule" serial NOT NULL,
    "date" DATE NOT NULL,
    "time_from" TIME,
    "time_to" TIME,
    "note" VARCHAR(255),
...
CREATE INDEX "spy_acl_group_archive_i_d6e8ac" ON "spy_acl_group_archive" ("reference");
...
ALTER TABLE "spy_merchant" ADD CONSTRAINT "spy_merchant-fk_state_machine_process"
    FOREIGN KEY ("fk_state_machine_process")
    REFERENCES "spy_state_machine_process" ("id_state_machine_process");

ALTER TABLE "spy_merchant_store" ADD CONSTRAINT "spy_merchant_store-fk_merchant"
    FOREIGN KEY ("fk_merchant")
    REFERENCES "spy_merchant" ("id_merchant");

ALTER TABLE "spy_merchant_store" ADD CONSTRAINT "spy_merchant_store-fk_store"
    FOREIGN KEY ("fk_store")
    REFERENCES "spy_store" ("id_store");

ALTER TABLE "spy_merchant_opening_hours_weekday_schedule" ADD CONSTRAINT "spy_merchant_opening_hours_weekday_schedule-fk_weekday_schedule"
    FOREIGN KEY ("fk_weekday_schedule")
    REFERENCES "spy_weekday_schedule" ("id_weekday_schedule")
    ON DELETE CASCADE;

ALTER TABLE "spy_merchant_opening_hours_weekday_schedule" ADD CONSTRAINT "spy_merchant_opening_hours_weekday_schedule-fk_merchant"
    FOREIGN KEY ("fk_merchant")
    REFERENCES "spy_merchant" ("id_merchant")
    ON DELETE CASCADE;

ALTER TABLE "spy_merchant_opening_hours_date_schedule" ADD CONSTRAINT "spy_merchant_opening_hours_date_schedule-fk_w_s_e_d"
    FOREIGN KEY ("fk_date_schedule")
    REFERENCES "spy_date_schedule" ("id_date_schedule")
    ON DELETE CASCADE;

ALTER TABLE "spy_merchant_opening_hours_date_schedule" ADD CONSTRAINT "spy_merchant_opening_hours_date_schedule-fk_merchant"
    FOREIGN KEY ("fk_merchant")
    REFERENCES "spy_merchant" ("id_merchant")
    ON DELETE CASCADE;

ALTER TABLE "spy_merchant_profile" ADD CONSTRAINT "spy_merchant_profile-fk_merchant"
    FOREIGN KEY ("fk_merchant")
    REFERENCES "spy_merchant" ("id_merchant");

ALTER TABLE "spy_merchant_profile_address" ADD CONSTRAINT "spy_merchant_profile_address-fk_country"
    FOREIGN KEY ("fk_country")
    REFERENCES "spy_country" ("id_country");

ALTER TABLE "spy_merchant_profile_address" ADD CONSTRAINT "spy_merchant_profile_address-fk_merchant_profile"
...
ALTER TABLE "spy_merchant_sales_order_item" ADD CONSTRAINT "spy_merchant_sales_order_item-fk_state_machine_item_state"
    FOREIGN KEY ("fk_state_machine_item_state")
    REFERENCES "spy_state_machine_item_state" ("id_state_machine_item_state");

ALTER TABLE "spy_merchant_sales_order_item" ADD CONSTRAINT "spy_merchant_sales_order_item-fk_sales_order_item"
    FOREIGN KEY ("fk_sales_order_item")
    REFERENCES "spy_sales_order_item" ("id_sales_order_item");

ALTER TABLE "spy_merchant_sales_order_item" ADD CONSTRAINT "spy_merchant_sales_order_item-fk_merchant_sales_order"
    FOREIGN KEY ("fk_merchant_sales_order")
    REFERENCES "spy_merchant_sales_order" ("id_merchant_sales_order");

ALTER TABLE "spy_merchant_sales_order" ADD CONSTRAINT "spy_merchant_sales_order-fk_sales_order"
    FOREIGN KEY ("fk_sales_order")
    REFERENCES "spy_sales_order" ("id_sales_order");

ALTER TABLE "spy_merchant_sales_order_totals" ADD CONSTRAINT "spy_merchant_sales_order_totals-fk_merchant_sales_order"
    FOREIGN KEY ("fk_merchant_sales_order")
    REFERENCES "spy_merchant_sales_order" ("id_merchant_sales_order");

ALTER TABLE "spy_merchant_stock" ADD CONSTRAINT "spy_merchant_stock-fk_stock"
    FOREIGN KEY ("fk_stock")
    REFERENCES "spy_stock" ("id_stock")
    ON DELETE CASCADE;

ALTER TABLE "spy_merchant_stock" ADD CONSTRAINT "spy_merchant_stock-fk_merchant"
    FOREIGN KEY ("fk_merchant")
    REFERENCES "spy_merchant" ("id_merchant")
    ON DELETE CASCADE;

ALTER TABLE "spy_merchant_user" ADD CONSTRAINT "spy_merchant_user-fk_user"
    FOREIGN KEY ("fk_user")
    REFERENCES "spy_user" ("id_user");

ALTER TABLE "spy_merchant_user" ADD CONSTRAINT "spy_merchant_user-fk_merchant"
    FOREIGN KEY ("fk_merchant")
    REFERENCES "spy_merchant" ("id_merchant");
...
ALTER TABLE "spy_price_product_offer" ADD CONSTRAINT "spy_price_product_offer-fk_product_offer"
    FOREIGN KEY ("fk_product_offer")
    REFERENCES "spy_product_offer" ("id_product_offer")
    ON DELETE CASCADE;

ALTER TABLE "spy_price_product_offer" ADD CONSTRAINT "spy_price_product_offer-fk_price_product_store"
    FOREIGN KEY ("fk_price_product_store")
    REFERENCES "spy_price_product_store" ("id_price_product_store");
...
ALTER TABLE "spy_product_offer" ADD CONSTRAINT "spy_product_offer-fk_merchant"
    FOREIGN KEY ("fk_merchant")
    REFERENCES "spy_merchant" ("id_merchant");

ALTER TABLE "spy_product_offer_store" ADD CONSTRAINT "spy_product_offer_store-fk_product_offer"
    FOREIGN KEY ("fk_product_offer")
    REFERENCES "spy_product_offer" ("id_product_offer");

ALTER TABLE "spy_product_offer_store" ADD CONSTRAINT "spy_product_offer_store_store-fk_store"
    FOREIGN KEY ("fk_store")
    REFERENCES "spy_store" ("id_store");

ALTER TABLE "spy_product_offer_stock" ADD CONSTRAINT "spy_product_offer_stock-fk_product_offer"
    FOREIGN KEY ("fk_product_offer")
    REFERENCES "spy_product_offer" ("id_product_offer");

ALTER TABLE "spy_product_offer_stock" ADD CONSTRAINT "spy_product_offer_stock-fk_stock"
    FOREIGN KEY ("fk_stock")
    REFERENCES "spy_stock" ("id_stock");

ALTER TABLE "spy_product_offer_validity" ADD CONSTRAINT "spy_product_offer_validity-fk_product_offer"
    FOREIGN KEY ("fk_product_offer")
    REFERENCES "spy_product_offer" ("id_product_offer");
...
ALTER TABLE "spy_url" ADD CONSTRAINT "spy_url-fk_resource_merchant"
...
DROP TABLE IF EXISTS "spy_merchant_store" CASCADE;

DROP SEQUENCE "id_merchant_store_pk_seq";

DROP TABLE IF EXISTS "spy_merchant_opening_hours_weekday_schedule" CASCADE;

DROP SEQUENCE "spy_merchant_opening_hours_weekday_schedule_pk_seq";

DROP TABLE IF EXISTS "spy_merchant_opening_hours_date_schedule" CASCADE;

DROP SEQUENCE "spy_merchant_opening_hours_date_schedule_pk_seq";

DROP TABLE IF EXISTS "spy_merchant_opening_hours_storage" CASCADE;

DROP SEQUENCE "id_merchant_opening_hours_storage_pk_seq";

DROP TABLE IF EXISTS "spy_merchant_profile" CASCADE;

DROP TABLE IF EXISTS "spy_merchant_profile_address" CASCADE;

DROP SEQUENCE "spy_merchant_profile_address_pk_seq";
...
DROP TABLE IF EXISTS "spy_merchant_sales_order_item" CASCADE;

DROP SEQUENCE "spy_merchant_sales_order_item_pk_seq";

DROP TABLE IF EXISTS "spy_merchant_sales_order" CASCADE;

DROP SEQUENCE "spy_merchant_sales_order_pk_seq";

DROP TABLE IF EXISTS "spy_merchant_sales_order_totals" CASCADE;

DROP SEQUENCE "spy_merchant_sales_order_totals_pk_seq";

DROP TABLE IF EXISTS "spy_merchant_stock" CASCADE;

DROP SEQUENCE "spy_merchant_stock_pk_seq";

DROP TABLE IF EXISTS "spy_merchant_storage" CASCADE;

DROP TABLE IF EXISTS "spy_merchant_user" CASCADE;

DROP SEQUENCE "spy_merchant_user_pk_seq";
...
DROP TABLE IF EXISTS "spy_price_product_offer" CASCADE;

DROP SEQUENCE "spy_price_product_offer_pk_seq";
...
DROP TABLE IF EXISTS "spy_product_concrete_product_offer_price_storage" CASCADE;

DROP SEQUENCE "spy_product_concrete_product_offer_price_storage_pk_seq";

DROP TABLE IF EXISTS "spy_product_concrete_product_offers_storage" CASCADE;

DROP SEQUENCE "spy_product_concrete_product_offers_storage_pk_seq";
...
DROP TABLE IF EXISTS "spy_product_offer" CASCADE;

DROP SEQUENCE "spy_product_offer_pk_seq";

DROP TABLE IF EXISTS "spy_product_offer_store" CASCADE;

DROP TABLE IF EXISTS "spy_product_offer_availability_storage" CASCADE;

DROP SEQUENCE "id_product_offer_availability_storage_pk_seq";

DROP TABLE IF EXISTS "spy_product_offer_stock" CASCADE;

DROP SEQUENCE "spy_product_offer_stock_pk_seq";

DROP TABLE IF EXISTS "spy_product_offer_storage" CASCADE;

DROP SEQUENCE "spy_product_offer_storage_pk_seq";

DROP TABLE IF EXISTS "spy_product_offer_validity" CASCADE;

DROP SEQUENCE "spy_product_offer_validity_pk_seq";
...
DROP TABLE IF EXISTS "spy_weekday_schedule" CASCADE;

DROP SEQUENCE "spy_weekday_schedule_pk_seq";

DROP TABLE IF EXISTS "spy_date_schedule" CASCADE;
