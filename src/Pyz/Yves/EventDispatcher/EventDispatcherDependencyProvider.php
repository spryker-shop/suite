...
use Spryker\Yves\Kernel\Plugin\EventDispatcher\RedirectUrlWhitelistValidationEventDispatcherPlugin;
...
class EventDispatcherDependencyProvider extends SprykerEventDispatcherDependencyProvider
{
    ...
    protected function getEventDispatcherPlugins(): array
    {
        return [
            ...
            new RedirectUrlWhitelistValidationEventDispatcherPlugin(),
        ];
    }
}
