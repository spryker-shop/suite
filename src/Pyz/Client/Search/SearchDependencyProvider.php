...
use Spryker\Client\MerchantProductOfferSearch\Plugin\MerchantReferenceSearchConfigExpanderPlugin;
...
class SearchDependencyProvider extends SprykerSearchDependencyProvider
{
    ...
    protected function createSearchConfigExpanderPlugins(Container $container)
    {
        ...
        $searchConfigExpanderPlugins[] = new MerchantReferenceSearchConfigExpanderPlugin();
