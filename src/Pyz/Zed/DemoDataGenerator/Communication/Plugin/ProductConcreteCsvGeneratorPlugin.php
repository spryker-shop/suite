 ...
 */
class ProductConcreteCsvGeneratorPlugin extends AbstractPlugin implements DemoDataGeneratorPluginInterface
{
    protected const PLUGIN_TYPE = 'product_concrete';
