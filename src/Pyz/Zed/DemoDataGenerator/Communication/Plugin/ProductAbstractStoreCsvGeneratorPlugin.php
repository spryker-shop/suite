 ...
 */
class ProductAbstractStoreCsvGeneratorPlugin extends AbstractPlugin implements DemoDataGeneratorPluginInterface
{
    protected const PLUGIN_TYPE = 'product_abstract_store';
    ...
    {
        $this->getFacade()->createProductAbstractStoreCsvDemoData($demoDataGeneratorTransfer);
    }
}
