 ...
 */
class ProductAbstractCsvGeneratorPlugin extends AbstractPlugin implements DemoDataGeneratorPluginInterface
{
    protected const PLUGIN_TYPE = 'product_abstract';
    ...
    {
        $this->getFacade()->createProductAbstractCsvDemoData($demoDataGeneratorTransfer->getRowNumber());
    }
}
