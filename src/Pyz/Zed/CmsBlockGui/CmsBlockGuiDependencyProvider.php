...
use Spryker\Zed\ContentGui\Communication\Plugin\CmsBlockGui\HtmlToTwigExpressionCmsBlockGlossaryBeforeSavePlugin;
use Spryker\Zed\ContentGui\Communication\Plugin\CmsBlockGui\TwigExpressionToHtmlCmsBlockGlossaryAfterFindPlugin;
...
class CmsBlockGuiDependencyProvider extends CmsBlockGuiCmsBlockGuiDependencyProvider
{
    ...
    {
        return [
            new TwigExpressionToHtmlCmsBlockGlossaryAfterFindPlugin(),
        ];
    }
    ...
    {
        return [
            new HtmlToTwigExpressionCmsBlockGlossaryBeforeSavePlugin(),
        ];
    }
}
