...
class QuoteConfig extends SprykerQuoteConfig
{
    ...
    public function getQuoteItemFieldsAllowedForSaving(): array
    {
        return [
            ...
            ItemTransfer::SOURCE_UNIT_GROSS_PRICE,
            ItemTransfer::SOURCE_UNIT_NET_PRICE,
            ItemTransfer::PRODUCT_PACKAGING_UNIT,
            ItemTransfer::AMOUNT,
            ItemTransfer::AMOUNT_SALES_UNIT,
            ItemTransfer::AMOUNT_LEAD_PRODUCT,
            ItemTransfer::GIFT_CARD_METADATA,
            ItemTransfer::PRODUCT_OPTIONS,
            ItemTransfer::CONFIGURED_BUNDLE,
            ItemTransfer::CONFIGURED_BUNDLE_ITEM,
