...
use Spryker\Zed\MinimumOrderValue\Communication\Plugin\Checkout\OrderMinimumOrderValueFeesSavePlugin;
...
class CheckoutDependencyProvider extends SprykerCheckoutDependencyProvider
{
    ...
    protected function getCheckoutPreConditions(Container $container)
    {
        return [
            ...
            new MinimumOrderValueCheckoutPreConditionPlugin(),
        ];
    }
    ...
    protected function getCheckoutOrderSavers(Container $container)
    {
        return [
            ...
            new OrderMinimumOrderValueFeesSavePlugin(), #MinimumOrderValueFeature
        ];
    }
