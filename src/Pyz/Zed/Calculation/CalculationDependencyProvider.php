...
use Spryker\Zed\PersistentCart\Communication\Plugin\Calculation\QuoteAttributesSavePostQuoteRecalculatePlugin;
...
class CalculationDependencyProvider extends SprykerCalculationDependencyProvider
{
    ...
    {
        return [
            new QuoteAttributesSavePostQuoteRecalculatePlugin(),
        ];
    }
}
