...
use Spryker\Zed\CompanyBusinessUnitGui\Communication\Plugin\BusinessUnitFieldCustomerCompanyAttachFormExpander;
...
use Spryker\Zed\CompanyRoleGui\Communication\Plugin\CompanyRoleFieldCustomerCompanyAttachFormExpander;
...
class CompanyUserGuiDependencyProvider extends SprykerCompanyUserGuiDependencyProvider
{
    ...
    {
        return [
            new BusinessUnitFieldCustomerCompanyAttachFormExpander(),
            new CompanyRoleFieldCustomerCompanyAttachFormExpander(),
        ];
    }
}
