...
class TransferConfig extends SprykerTransferConfig
{
    ...
    protected function getCoreSourceDirectoryGlobPatterns(): array
    {
        ...
        $directoryGlobPatterns[] = APPLICATION_VENDOR_DIR . '/spryker/spryker/Features/*/src/SprykerFeature/Shared/*/Transfer/';
    ...
    public function getDataBuilderSourceDirectories(): array
    {
        ...
        $globPatterns[] = APPLICATION_VENDOR_DIR . '/spryker/spryker/Features/*/tests/_data/';
