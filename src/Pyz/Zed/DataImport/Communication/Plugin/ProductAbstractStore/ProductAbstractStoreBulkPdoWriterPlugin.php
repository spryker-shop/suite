 ...
 */
class ProductAbstractStoreBulkPdoWriterPlugin extends AbstractPlugin implements DataSetWriterPluginInterface, DataSetWriterPluginApplicableAwareInterface
{
    /**
    ...
    {
        $this->getFacade()->writeProductAbstractStorePdoDataSet($dataSet);
    }
    ...
    {
        $this->getFacade()->flushProductAbstractStorePdoDataImporter();
    }
