 ...
 */
class ProductConcreteBulkPdoWriterPlugin extends AbstractPlugin implements DataImportWriterPluginInterface, DataImportFlushPluginInterface
{
    /**
    ...
    {
        $this->getFacade()->writeProductConcretePdoDataSet($dataSet);
    }
