...
use Spryker\Zed\MerchantOpeningHoursStorage\Communication\Plugin\Event\MerchantOpeningHoursScheduleEventResourceBulkRepositoryPlugin;
...
class EventBehaviorDependencyProvider extends SprykerEventBehaviorDependencyProvider
{
    ...
    protected function getEventTriggerResourcePlugins()
    {
        return [
            ...
            new MerchantOpeningHoursScheduleEventResourceBulkRepositoryPlugin(),
        ];
    }
}
