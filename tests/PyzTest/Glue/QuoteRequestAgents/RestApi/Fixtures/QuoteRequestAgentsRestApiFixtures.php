...
namespace PyzTest\Glue\QuoteRequestAgents\RestApi\Fixtures;
...
class QuoteRequestAgentsRestApiFixtures implements FixturesBuilderInterface, FixturesContainerInterface
{
    /**
     * @var string
     */
    protected const TEST_USERNAME = 'QuoteRequestAgentsRestApiFixtures';
     ...
     */
    public function buildFixtures(QuoteRequestAgentsApiTester $I): FixturesContainerInterface
    {
        ...
        $this->userTransfer = $I->createAgentUser();
