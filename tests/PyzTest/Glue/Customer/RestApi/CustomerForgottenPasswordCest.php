...
class CustomerForgottenPasswordCest
{
     ...
     * @return void
     */
    public function requestPostCustomerForgottenPasswordRunsOk(CustomerApiTester $I): void
    {
        $I->markTestSkipped('The positive test is skipped till a Glue test bootstrap is introduced.');

        $restCustomerForgottenPasswordAttributesTransfer = (new RestCustomerForgottenPasswordAttributesTransfer())
            ->setEmail($this->customerTransfer->getEmail());
