...
use PyzTest\Glue\Checkout\RestApi\Fixtures\CompanyUserOrderAmendmentCheckoutRestApiFixtures;
 ...
 * @group Checkout
 * @group RestApi
 * @group CompanyUserOrderAmendmentCheckoutRestApiCest
 * Add your own group annotations below this line
 * @group EndToEnd
 */
class CompanyUserOrderAmendmentCheckoutRestApiCest
{
    protected CompanyUserOrderAmendmentCheckoutRestApiFixtures $fixtures;

    public function loadFixtures(CheckoutApiTester $I): void
    {
        /** @var \PyzTest\Glue\Checkout\RestApi\Fixtures\CompanyUserOrderAmendmentCheckoutRestApiFixtures $fixtures */
        $fixtures = $I->loadFixtures(CompanyUserOrderAmendmentCheckoutRestApiFixtures::class);
