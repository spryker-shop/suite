 ...
 *
 * @link https://spryker.atlassian.net/wiki/spaces/CORE/pages/3021211004/Case+16+Prioritization+-+Percentage+discount+single+product+voucher+code+fixed+amount+discount+cart+rule
 * Case 16: [Prioritization] - Percentage discount (single product, voucher code) + fixed amount discount (cart rule).
 *
 ...
 */
class Case16Test extends Unit
{
    /**
     * @var string
     */
    protected const TEST_PRODUCT_1_ABSTRACT_SKU = 'CASE16_P1';

    /**
     * @var string
     */
    protected const TEST_PRODUCT_1_SKU = 'CASE16_P1_SKU';
     ...
     * @var string
     */
    protected const TEST_PRODUCT_2_ABSTRACT_SKU = 'CASE16_P2';

    /**
     * @var string
     */
    protected const TEST_PRODUCT_2_SKU = 'CASE16_P2_SKU';
     ...
     * @var int
     */
    protected const DISCOUNT_PRIORITY_TWO = 100;

    /**
     * @var string
     */
    protected const DISCOUNT_DECISION_RULE_TWO = "sku = 'CASE16_P2_SKU'";

    /**
     * @var string
     */
    protected const DISCOUNT_COLLECTOR_QUERY_STRING_TWO = "sku = 'CASE16_P2_SKU'";
     ...
     * @return void
     */
    public function testQuoteTotalsWhenPercentageDiscountVoucherAppliedToOneProductAndFixedDiscountAppliedToCart(): void
    {
        // Arrange
