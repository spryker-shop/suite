...
/**
 * Two discounts apply to a cart. One is a fixed amount discount taken off all SKUs in the cart, the other is a percentage discount applied to all SKUs in the cart with the entry of a voucher code.
 *
 * Discount use case intro: {@link https://spryker.atlassian.net/wiki/spaces/CORE/pages/2896527845/Discount+Use+Cases}
 *
 * @link https://spryker.atlassian.net/wiki/spaces/CORE/pages/3021210879/Case+15+Prioritization+-+Fixed+amount+discount+cart+rule+percentage+discount+voucher+code
 * Case 15: [Prioritization] - Fixed amount discount (cart rule) + percentage discount (voucher code).
 *
 ...
 */
class Case15Test extends Unit
{
    /**
     * @var string
     */
    protected const TEST_PRODUCT_1_ABSTRACT_SKU = 'CASE15_P1';

    /**
     * @var string
     */
    protected const TEST_PRODUCT_1_SKU = 'CASE15_P1_SKU';
     ...
     * @var string
     */
    protected const TEST_PRODUCT_2_ABSTRACT_SKU = 'CASE15_P2';

    /**
     * @var string
     */
    protected const TEST_PRODUCT_2_SKU = 'CASE15_P2_SKU';
     ...
     * @var string
     */
    protected const DISCOUNT_NAME_ONE = '€15 off €100+';

    /**
     * @var int
     */
    protected const DISCOUNT_AMOUNT_ONE = 1500;

    /**
     * @var int
     */
    protected const DISCOUNT_PRIORITY_ONE = 205;
     ...
     * @var int
     */
    protected const DISCOUNT_PRIORITY_TWO = 175;
     ...
     * @var int
     */
    protected const EXPECTED_GRAND_TOTAL = 16500;
     ...
     * @var int
     */
    protected const EXPECTED_DISCOUNT_TOTAL = 3500;
     ...
     * @return void
     */
    public function testQuoteTotalsWhenPrioritizedFixedDiscountAndPercentageVoucherDiscountsAppliedToCart(): void
    {
        // Arrange
